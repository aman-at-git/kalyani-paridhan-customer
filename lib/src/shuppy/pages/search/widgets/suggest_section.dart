            ...
            children: <Widget>[
              ListTile(
                ...
                onTap: () {
                  ...
                  //   arguments: data,
                  // );
                  Get.toNamed<dynamic>(ShuppyRoutes.product, arguments: ProductArgument(product: data, query: FirebaseFirestore.instance.collection('recent').orderBy('time', descending: true)));
                },
              ),
              const Divider(),
            ],
