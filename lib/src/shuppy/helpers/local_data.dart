...
import 'package:ultimate_bundle/src/shuppy/models/category_model.dart';
import 'package:ultimate_bundle/src/shuppy/models/favorite_model.dart';
import 'package:ultimate_bundle/src/shuppy/models/notification_model.dart';
import 'package:ultimate_bundle/src/shuppy/models/on_boarding_model.dart';
import 'package:ultimate_bundle/src/shuppy/models/order_model.dart';
import 'package:ultimate_bundle/src/shuppy/models/payment_method_model.dart';
import 'package:ultimate_bundle/src/shuppy/models/product_model.dart';
import 'package:ultimate_bundle/src/shuppy/pages/cart/cart_page.dart';
...
class LocalList {
  ...
  static List<CategoryModel> allCategoryListMen() => [
        CategoryModel(
          id: 1,
          label: 'Shirt',
          icon: Images.shirt,
  ...
  static List<CategoryModel> allCategoryListWomen() => [
    CategoryModel(
      id: 1,
      label: 'Suit',
      icon: Images.suit,
